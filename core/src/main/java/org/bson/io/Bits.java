...
public class Bits {
     ...
     * {@link #readFully(InputStream, byte[], int, int)} with an offset of zero and a length equal to the length of the buffer.
     *
    ...
    /**
     * Reads bytes from the input stream and puts them into the given byte buffer. The equivalent of calling
     * {@link #readFully(InputStream, byte[], int, int)} with an offset of zero.
     *
     * @param inputStream the input stream to read from
     * @param buffer      the buffer into which the data is read.
