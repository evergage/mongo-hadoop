...
/**
 * <p>A thread-safe variant of {@link Map} in which all mutative operations (the "destructive" operations described by {@link
 * Map} put, remove and so on) are implemented by making a fresh copy of the underlying map.</p>
 *
 ...
 * supported. The mutable operations on these collections (remove, retain etc.) are supported but as with the {@link Map}
 ...
 * {@link #copy(Map)} method. The method is responsible for the underlying Map implementation (for instance a {@link
 * HashMap}, {@link java.util.TreeMap}, {@link LinkedHashMap} etc.) and therefore the semantics of what this map will
 ...
 * implementations </p>
 *
 * <p>There are supplied implementations for the common j.u.c {@link Map} implementations via the {@link org.bson.util.CopyOnWriteMap} static
 * {@link Builder}. </p>
 *
 ...
 * LinkedHashMap} with access ordering are actually structurally modified by the {@link #get(Object)} method and are therefore not
...
abstract class CopyOnWriteMap<K, V> extends AbstractCopyOnWriteMap<K, V, Map<K, V>> {
    ...
    /**
     * Build a {@link org.bson.util.CopyOnWriteMap} and specify all the options.
     *
     * @param <K> key type
     * @param <V> value type
     */
    public static class Builder<K, V> {
        ...
        public org.bson.util.CopyOnWriteMap<K, V> newHashMap() {
            return new Hash<K, V>(initialValues, viewType);
        }

        public org.bson.util.CopyOnWriteMap<K, V> newLinkedMap() {
            return new Linked<K, V>(initialValues, viewType);
        }
    }

    /**
     * <p> Creates a new {@link org.bson.util.CopyOnWriteMap} with an underlying {@link HashMap}. </p>
     *
    ...
    /**
     * <p> Creates a new {@link org.bson.util.CopyOnWriteMap} with an underlying {@link HashMap} using the supplied map as the initial values. </p>
     *
     * <p>This map has {@link View.Type#STABLE stable} views.</p>
     */
    public static <K, V> org.bson.util.CopyOnWriteMap<K, V> newHashMap(final Map<? extends K, ? extends V> map) {
        Builder<K, V> builder = builder();
        return builder.addAll(map).newHashMap();
    }

    /**
     * <p>Creates a new {@link org.bson.util.CopyOnWriteMap} with an underlying {@link LinkedHashMap}. Iterators for this map will be return
    ...
    /**
     * <p>Creates a new {@link org.bson.util.CopyOnWriteMap} with an underlying {@link LinkedHashMap} using the supplied map as the initial
     * values. Iterators for this map will be return elements in insertion order. </p>
     *
     * <p>This map has {@link View.Type#STABLE stable} views.</p>
     */
    public static <K, V> org.bson.util.CopyOnWriteMap<K, V> newLinkedMap(final Map<? extends K, ? extends V> map) {
        Builder<K, V> builder = builder();
    ...
    /**
     * Create a new {@link org.bson.util.CopyOnWriteMap} with the supplied {@link Map} to initialize the values.
     *
    ...
    /**
     * Create a new empty {@link org.bson.util.CopyOnWriteMap}.
     *
     * @deprecated since 0.0.12 use the versions that explicitly specify View.Type
     */
    @Deprecated
    ...
    /**
     * Create a new {@link org.bson.util.CopyOnWriteMap} with the supplied {@link Map} to initialize the values. This map may be optionally modified using
    ...
    /**
     * Create a new empty {@link org.bson.util.CopyOnWriteMap}. This map may be optionally modified using any of the key, entry or value views
     */
     ...
     */
    static class Hash<K, V> extends org.bson.util.CopyOnWriteMap<K, V> {
     ...
     */
    static class Linked<K, V> extends org.bson.util.CopyOnWriteMap<K, V> {
