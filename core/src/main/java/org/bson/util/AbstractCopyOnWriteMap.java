...
abstract class AbstractCopyOnWriteMap<K, V, M extends Map<K, V>> implements ConcurrentMap<K, V> {
    ...
    private class KeySet extends CollectionView<K> implements Set<K> {
        ...
        public boolean remove(final Object o) {
            return org.bson.util.AbstractCopyOnWriteMap.this.remove(o) != null;
        }
    ...
    public abstract static class View<K, V> {
        ...
        public enum Type {
            STABLE {
                @Override
                <K, V, M extends Map<K, V>> View<K, V> get(final org.bson.util.AbstractCopyOnWriteMap<K, V, M> host) {
            ...
            abstract <K, V, M extends Map<K, V>> View<K, V> get(org.bson.util.AbstractCopyOnWriteMap<K, V, M> host);
        }
    }
