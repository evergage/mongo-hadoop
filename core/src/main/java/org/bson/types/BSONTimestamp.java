 ...
 */
public final class BSONTimestamp implements Comparable<org.bson.types.BSONTimestamp>, Serializable {
    ...
    @Override
    public int compareTo(final org.bson.types.BSONTimestamp ts) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof org.bson.types.BSONTimestamp) {
            org.bson.types.BSONTimestamp t2 = (org.bson.types.BSONTimestamp) obj;
