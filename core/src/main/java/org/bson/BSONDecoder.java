...
public interface BSONDecoder {
     ...
     * @return the BSON object for the given bytes
     * @throws IOException if there's a problem reading the object from the {@code InputStream}
     */
     ...
     * @throws IOException if there's a problem reading from the {@code InputStream}
     */
